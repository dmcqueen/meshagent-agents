...
- Apply the shared verification discipline from `../_shared/references/workflow_accountability.md`, then use this skill's DB-specific rules for what counts as proof here.
- Apply the shared debugging discipline from `../_shared/references/workflow_accountability.md`, then use this skill's DB-specific rules to separate schema, permission, deployed-artifact, and read-back failures.
