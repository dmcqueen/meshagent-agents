...
_Generated from the local MeshAgent CLI installation using `scripts/refresh_cli_reference.sh`._
...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.  [default: 203b1bf9-72c9-4022-bfaa-55d6f656dfeb]
...
* `--arguments TEXT`: JSON string with arguments for the call  [default: \{#123;\}#125;]
...
* `--header-secret TEXT`: Header from secret (HEADER:FORMAT). FORMAT uses secret placeholders, e.g. Header:Bearer \{#123;my_secret\}#125;
...
* `--annotations TEXT`: Optional JSON object for room annotations, e.g. \{#123;&quot;meshagent.storage.class&quot;:&quot;ephemeral&quot;\}#125;
* `--help`: Show this message and exit.
...
* `-n, --annotations TEXT`: annotations in json format \{#123;&quot;name&quot;:&quot;value&quot;\}#125;
* `--help`: Show this message and exit.
...
* `--payload TEXT`: JSON payload to enqueue (for example &#x27;\{#123;&quot;action&quot;:&quot;sync&quot;\}#125;&#x27;)
...
- `python` and `static` sources that start with `/` resolve to `\{#123;cwd\}#125;/...`.
...
```console
$ meshagent test [OPTIONS] COMMAND [ARGS]...
```
...
* `stream-tool`: Host a hidden streaming test tool with a...

### `meshagent test stream-tool`

Host a hidden streaming test tool with a textual UI

**Usage**:

```console
$ meshagent test stream-tool [OPTIONS]
```
...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.  [default: 203b1bf9-72c9-4022-bfaa-55d6f656dfeb]
* `--room TEXT`: Room name  [required]
* `--name TEXT`: Participant name  [default: stream-tool-test]
* `--role TEXT`: Participant role  [default: tool]
* `--toolkit TEXT`: Toolkit name  [default: test-stream-toolkit]
* `--tool TEXT`: Tool name  [default: stream]
* `--key TEXT`: API key for signing a participant token
* `--help`: Show this message and exit.
...
* `--require-table-read TEXT`: Enable table read tools for a specific table
* `--require-table-write TEXT`: Enable table write tools for a specific table
* `--require-computer-use / --no-require-computer-use`: Enable computer use  [default: no-require-computer-use]
* `--starting-url TEXT`: Initial URL to open when starting a computer-use browser session
* `--allow-goto-url`: Expose the goto URL helper tool for computer use
...
* `-a, --annotations TEXT`: annotations in json format \{#123;&quot;name&quot;:&quot;value&quot;\}#125;  [default: \{#123;&quot;meshagent.task-runner.attachment-format&quot;:&quot;tar&quot;\}#125;]
...
* `-n, --namespace TEXT`: Namespace path segments (repeatable). Example: -n prod -n analytics
* `-c, --columns TEXT`: Comma-separated column definitions. Example: &quot;names vector(20) null, tags list(text), meta struct(owner text, score float)&quot;. Allowed types: int, bool, date, timestamp, float, text, binary, vector, list, struct. Vector syntax: vector(size[, element_type]). List syntax: list(element_type). Struct syntax: struct(field_name type[, ...]).
* `--columns-json TEXT`: JSON object of new columns. Supports DataType JSON including list/struct (e.g. &#x27;\{#123;&quot;meta&quot;:\{#123;&quot;type&quot;:&quot;struct&quot;,&quot;fields&quot;:\{#123;&quot;owner&quot;:\{#123;&quot;type&quot;:&quot;text&quot;\}#125;\}#125;\}#125;\}#125;&#x27;).
* `--help`: Show this message and exit.
...
* `-n, --namespace TEXT`: Namespace path segments (repeatable). Example: -n prod -n analytics
* `--tables-json TEXT`: JSON array of table refs (e.g. &#x27;[\{#123;&quot;name&quot;:&quot;users&quot;,&quot;alias&quot;:&quot;u&quot;,&quot;namespace&quot;:[&quot;prod&quot;]\}#125;]&#x27;)
...
* `--annotations-json TEXT`: Optional JSON map of string annotations, e.g. \{#123;&quot;origin&quot;:&quot;camera&quot;\}#125;
* `-n, --namespace TEXT`: Namespace path segments (repeatable). Example: -n prod -n analytics
* `--strategy [heuristic|llm]`: Ingest strategy: heuristic or llm  [default: heuristic]
* `--llm-model TEXT`: Model name for llm strategy
* `--llm-temperature FLOAT`: Temperature for llm strategy
...
```console
$ meshagent room container image build [OPTIONS]
```
...
* `--project-id TEXT`: A MeshAgent project id. If empty, the activated project will be used.  [default: 203b1bf9-72c9-4022-bfaa-55d6f656dfeb]
* `--room TEXT`: Room name  [required]
* `--tag TEXT`: Image tag to build, e.g. repo/name:tag  [required]
* `--context-path TEXT`: Build context path inside one of the mounted paths (absolute path)  [required]
* `--dockerfile-path TEXT`: Optional Dockerfile path inside one of the mounted paths (absolute path)
* `--mount-room-path TEXT`: Room storage mount &#x27;&lt;source&gt;:&lt;mount&gt;[:ro|rw]&#x27;. Example &#x27;/src:/workspace&#x27;
...
##### `meshagent room container images build`
...
```console
$ meshagent room container images build [OPTIONS]
```
